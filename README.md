...
reasoning effort: reasoning_effort 또는 reasoning.effort
...
CREATE=$(curl -sS http://192.168.0.16:31835/v1/chat/completions \
  -H "Authorization: Bearer $DOGOK_PROXY_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"model":"gpt-5.4-mini","messages":[{"role":"user","content":"hello"}],"reasoning_effort":"low"}')
